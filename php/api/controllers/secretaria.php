<?php
    ...
    class Secretaria {
        ...
        /**
         * Genera el certificado de asistencia en PDF para un alumno y año dados.
         * @param int $id ID del alumno.
         * @param int $anio Año escolar (ej. 2025).
         * @param int $anioSig Año siguiente (ej. 2026).
         * @return void
         */
