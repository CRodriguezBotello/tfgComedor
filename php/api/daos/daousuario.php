<?php
    ...
    class DAOUsuario {
        ...
        /**
         * Actualizar la fecha de firma del mandato SEPA de una persona.
        ...
        /**
         * Desactivar padre y sus hijos.
         * @param int $idPersona ID de la persona padre.
         * @return void
         */
        ...
        /**
         * Eliminar hijo definitivamente.
         * @param int $idHijo ID del hijo.
         * @param int $idPadre ID del padre que solicita la eliminación.
         */
        ...
        /**
         * Obtener los días del calendario de los hijos de un padre en un mes y año determinados.
         * @param Integer $idPadre ID del padre.
        ...
        /**
         * Añade fila a tabla 'Persona' y crea entradas en 'Padre' y 'Hijo'.
         * @param string $sql Sentencia SQL de inserción en 'Persona'.
       ...
       public static function obtenerListadoPadresDesactivados() {
        ...
        /**
         * Obtener datos para remesa Q19 de un mes para un hijo específico.
         * @param integer $mes Mes.
         * @param integer $idHijo ID del hijo.
         */
        ...
        /**
         * Obtiene los tuppers de un día concreto.
        ...
        /**
         * Actualiza el campo tupper de un día concreto.
        ...
        /**
         * Obtiene los usuarios que han asistido en un año determinado.
