export class VistaGestionDiaria {
    ...
    /**
     * mostrar - Muestra u oculta la vista.
     * @param {*} ver 
     */
    mostrar(ver) {
    ...
    /**
     * obtenerDatos - Solicita al controlador los datos de los hijos para el usuario dado.
     * @param {*} usuario 
     */
    ...
    /**
     * cargarListado - Carga el listado de hijos en la tabla.
     * @param {*} hijos 
     * @param {*} cursosMap 
     * @param {*} idPadre 
     */
    ...
    /**
     * cambiarFecha - Cambia la fecha del input en el número de días indicado.
    ...
    /**
     * seleccionarFecha - Maneja la selección de fecha y carga los datos correspondientes.
     * @returns {void}
     */
    seleccionarFecha() {
        const fechaStr = this.div.querySelector('#fechaDiaria').value;
    ...
    /**
     * confirmar - Confirma y guarda los cambios realizados en la tabla.
     * @returns {void}
     */
    confirmar() {
