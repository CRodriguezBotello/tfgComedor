...
class LoginGoogle {
    ...
    /**
     * Función de prueba para simular el login con diferentes tokens.
     */
    test() {
    ...
    /**
     * login con el token proporcionado por Google.
     * @param {*} token 
     */
    async login(token) {
    ...
    /**
     * presenta un modal para que el admin elija a qué área ir.
     * @returns Promise<boolean> true si elige Secretaría, false si elige Padres.
     */
    askAdminChoice() {
