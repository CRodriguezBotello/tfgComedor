...
export class Modelo {
    ...
    /**
     * desactivarPadreSecretaria - Desactiva un padre en la vista de secretaria.
     * @param {*} padre 
    ...
    /**
     * reactivarPadreSecretaria - Reactiva un padre en la vista de secretaria.
     * @param {*} padre 
     * @returns respuesta de la API
     */
    ...
    /**
     * eliminarPadreSecretaria - Elimina definitivamente un padre en la vista de secretaria.
     * @param {*} padre 
     * @returns respuesta de la API
     */
    ...
    /**
     * obtenerUsuariosApuntadosMensual - Obtiene los usuarios apuntados al comedor en un mes.
     * @param {*} mes 
     * @returns respuesta de la API
     */
    obtenerUsuariosApuntadosMensual(mes) {
    ...
    /**
     * obtenerListadoPadres - Obtiene el listado de padres desde la vista de secretaria.
     * @param {*} busqueda 
     * @returns {Promise} Devuelve la promesa asociada a la petición.
     */
    ...
    /**
     * obtenerListadoPadresDesactivados - Obtiene el listado de padres desactivados desde la vista de secretaria.
     * @returns {Promise} Devuelve la promesa asociada a la petición.
     */
    ...
    /**
     * modificarPadreSecretaria - Modifica un padre desde la vista de secretaria.
     * @param {*} datos 
     * @returns put modificarPadreSecretaria
     */
    ...
    /**
     * obtenerQ19PorPersona - Obtiene los registros del Q19 de un mes por persona.
     * @param {*} mes 
     * @param {*} idPersona 
     * @returns respuesta de la API
     */
    ...
    /**
     * obtenerUsuariosAnual - Obtiene los usuarios apuntados al comedor en un año.
     * @param {*} anio 
     * @returns respuesta de la API
     */
